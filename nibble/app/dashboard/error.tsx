...
export default function DashboardError({
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { boundary: "app/dashboard/error", digest: error.digest ?? "none" },
    });
    ...
    <main className="grid min-h-[60vh] place-items-center p-8">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-[color:var(--muted)]">
          Ya quedó registrado. Si persiste, escríbenos al WhatsApp de soporte.
        </p>
        ...
        {!canRetry && (
          <p className="mt-3 text-xs text-[color:var(--muted)]">
            Probamos varias veces sin éxito. Vuelve al panel o escríbenos.
          </p>
        )}
      </div>
    </main>
